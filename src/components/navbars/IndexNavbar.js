      ...
      <nav className="fixed top-0 z-50 flex flex-wrap items-center justify-between w-full px-2 py-3 bg-white shadow navbar-expand-lg">
        <div className="container flex flex-wrap items-center justify-between px-4 mx-auto">
          <div className="relative flex justify-between w-full lg:w-auto lg:static lg:block lg:justify-start">
            <Link href="/">
              <a
                className="inline-block py-2 mr-4 text-sm font-bold leading-relaxed text-gray-800 uppercase whitespace-no-wrap"
                href="#pablo"
              >
                Notus NextJS
              </a>
          ...
          >
            <ul className="flex flex-col mr-auto list-none lg:flex-row">
              <li className="flex items-center">
                ...
                >
                  <i className="mr-2 text-lg text-gray-500 far fa-file-alt leading-lg" /> Docs
                </a>
              </li>
            </ul>
            <ul className="flex flex-col list-none lg:flex-row lg:ml-auto">
              ...
              <li className="flex items-center">
                <a
                  ...
                  rel="noreferrer"
                >
                  <i className="text-lg text-gray-500 fab fa-facebook leading-lg " />
              ...
              <li className="flex items-center">
                <a
                  ...
                  rel="noreferrer"
                >
                  <i className="text-lg text-gray-500 fab fa-twitter leading-lg " />
              ...
              <li className="flex items-center">
                <a
                  ...
                  rel="noreferrer"
                >
                  <i className="text-lg text-gray-500 fab fa-github leading-lg " />
