...
export default function CardSocialTraffic() {
  return (
    <>
      <div className="relative flex flex-col w-full min-w-0 mb-6 break-words bg-white rounded shadow">
        <div className="px-4 py-3 mb-0 border-0 rounded-t">
          <div className="flex flex-wrap items-center">
            <div className="relative flex-1 flex-grow w-full max-w-full px-2">
              <h3 className="text-lg font-semibold text-blueGray-700">Últimas ofertas</h3>
            </div>
