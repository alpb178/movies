import { ABOUT_PAGE, APP_NAME, BLOG_PAGE, CONTACT_PAGE, HELP_PAGE } from '@/lib/constants';
...
const navigation = {
  ...
  support: [
    // { name: 'Pricing', href: '#' },
    { name: 'help-center', href: HELP_PAGE },
    { name: 'contact', href: CONTACT_PAGE }
  ],
  company: [
    { name: 'about-us', href: ABOUT_PAGE },
    { name: 'blog', href: BLOG_PAGE }
  ],
  legal: [
    // { name: 'claim', href: '#' },
    ...
    <footer className="border-t bg-gray-50" aria-labelledby="footer-heading">
      ...
      <div className="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:py-8 lg:px-8">
        <div className="md:flex md:items-center md:justify-between">
          <div className="flex w-1/2 mt-12 space-x-6 md:order-2 md:w-1/6 xl:mt-0">
            <Menu className="w-max">
              {({ open }) => (
                <>
                  <Menu.Button className="relative flex items-center justify-between w-full p-3 bg-gray-100 rounded-md">
                  ...
                  <Transition
                    ...
                    className="absolute z-40 bg-white focus:outline-none focus:ring"
                  >
                    <Menu.Items
                      static
          ...
          <p className="mt-8 font-medium text-gray-500 md:mt-0 md:order-1">
